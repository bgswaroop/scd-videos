...
python3 /home/p288722/git_code/scd_videos_first_revision/run_train.py --frames_per_video=50 --homo_or_not=None --net_type=mobile --dataset=/data/p288722/datasets/vision/I_frame_splits/bal_all_frames --epochs=40 --lr=0.1 --batch_size=64 --height=480 --width=800 --use_pretrained=1 --gpu_id=0 --const_type=None --model_name=MobileNet_50_I_frames_ccrop_run1 --global_results_dir=/data/p288722/runtime_data/scd_videos_first_revision/09_triplets_bs128_lr0.001/50_frames/mobile_net > output.txt & disown
python3 /home/p288722/git_code/scd_videos_first_revision/run_evaluate.py --frames_per_video=50 --homo_or_not=None --eval_set=val --dataset=/data/p288722/datasets/vision/I_frame_splits/bal_all_frames --batch_size=64 --height=480 --width=800 --gpu_id=0 --suffix=50_frames_val --input_dir=/data/p288722/runtime_data/scd_videos_first_revision/09_triplets_bs128_lr0.001/50_frames/mobile_net/models/MobileNet_50_I_frames_ccrop_run1
python3 /home/p288722/git_code/scd_videos_first_revision/_miscellaneous/plots/validation_plots.py --val_summary=/data/p288722/runtime_data/scd_videos_first_revision/09_triplets_bs128_lr0.001/50_frames/mobile_net/models/MobileNet_50_I_frames_ccrop_run1/predictions_50_frames_val/videos/V_prediction_stats.csv
python3 /home/p288722/git_code/scd_videos_first_revision/run_evaluate.py --frames_per_video=50 --homo_or_not=None --eval_set=test --dataset=/data/p288722/datasets/vision/I_frame_splits/bal_all_frames --batch_size=64 --height=480 --width=800 --gpu_id=0 --suffix=50_frames --input_dir=/data/p288722/runtime_data/scd_videos_first_revision/09_triplets_bs128_lr0.001/50_frames_pred/mobile_net/models/MobileNet_50_I_frames_ccrop_run1
