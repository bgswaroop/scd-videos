...
#SBATCH --chdir=/scratch/p288722/runtime_data/scd_videos_first_revision/10_prnu_cortivo_baseline
...
#echo python3 /home/p288722/git_code/scd_videos_first_revision/run_train.py --homo_or_not=${homo_or_not} --net_type=${net} --dataset=${splits_dir} --category="whatsapp" --epochs=50 --lr=0.001 --batch_size=32 --height=480 --width=800 --use_pretrained=1 --gpu_id=0 --const_type=${const_type} --model_name="${model_name}" --global_results_dir="${base_dir}/${num_frames}_frames/${net}_net"
#echo python3 /home/p288722/git_code/scd_videos_first_revision/run_evaluate.py --homo_or_not=${homo_or_not} --eval_set="val" --dataset=${splits_dir} --category="whatsapp" --batch_size=64 --height=480 --width=800 --gpu_id=0 --suffix="${num_frames}_frames_val" --input_dir="${base_dir}/${num_frames}_frames/${net}_net/models/${model_name}"
...
#python3 /home/p288722/git_code/scd_videos_first_revision/run_evaluate.py --homo_or_not=${homo_or_not} --eval_set="val" --dataset=${splits_dir} --category="whatsapp" --batch_size=64 --height=480 --width=800 --gpu_id=0 --suffix="${num_frames}_frames_val" --input_dir="${base_dir}/${num_frames}_frames/${net}_net/models/${model_name}"
